...
![image-20220518154815562](../.gitbook/assets/202205181548621.png)

存在漏洞的文件为 `Application/Admin/Model/ThemeController.class.php`

![image-20220518154826306](../.gitbook/assets/202205181548388.png)

其中 theme参数为用户可控参数，根据函数流程可以发现存在的文件将会打包为 zip文件提供下载

![image-20220518154838931](../.gitbook/assets/202205181548023.png)
...
![image-20220518154851785](../.gitbook/assets/202205181548889.png)
