...
![image-20220518155003298](../.gitbook/assets/202205181550559.png)

我们需要访问一个存在的页面

url中13后加个单引号 `'`，若为执行sql报错相关,则漏洞存在

![image-20220518155017186](../.gitbook/assets/202205181550238.png)

若显示下图，则漏洞无法利用

![image-20220518155030427](../.gitbook/assets/202205181550475.png)
...
![image-20220518155108672](../.gitbook/assets/202205181551731.png)

通过此payload进行盲注Fuzz数据库中表单总数是否小于40

查询为真返回正常,假则报错

![image-20220518155128134](../.gitbook/assets/202205181551193.png)
...
![image-20220518155148056](../.gitbook/assets/202205181551121.png)
...
![image-20220518155205342](../.gitbook/assets/202205181552408.png)
