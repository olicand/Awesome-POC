# WeiPHP5.0 download\_imgage 前台文件任意读取 CNVD-2020-68596
...
![image-20220518155931404](../.gitbook/assets/202205181559468.png)

漏洞函数文件:`application\material\controller\Material.php`

漏洞函数:`_download_imgage`

![image-20220518160008264](../.gitbook/assets/202205181600401.png)
...
![image-20220518160112407](../.gitbook/assets/202205181601465.png)
...
![image-20220518160132259](../.gitbook/assets/202205181601329.png)

查看目录`/public/uploads/picture/`，并用记事本打开写入的jpg文件

![image-20220518160149362](../.gitbook/assets/202205181601445.png)

得到数据库配置文件的信息，既然这个变量可控，我们也可以通过这个方法下载木马文件，再通过解析漏洞或者文件包含等其他漏洞来getshell

![image-20220518160204626](../.gitbook/assets/202205181602698.png)

在当前条件下并不知道文件名是什么，所以回到代码中继续寻找可以获取文件名的办法

![image-20220518160225049](../.gitbook/assets/202205181602112.png)
...
![image-20220518160239897](../.gitbook/assets/202205181602963.png)
...
![image-20220518160254667](../.gitbook/assets/202205181602824.png)

我们现在则需要找到不需要登录的地方来获得这些数据，所以可以全局去查找调用了这个 Picture 表的地方

![image-20220518160312578](../.gitbook/assets/202205181603655.png)
...
![image-20220518160335575](../.gitbook/assets/202205181603854.png)

定义值默认为 1，所以这里调用则可以获得数据库中Pictrue表的内容，间接的知道了文件内容以及文件名

访问地址: http://webphp/public/index.php/home/file/user\_pids

![image-20220518160401674](../.gitbook/assets/202205181604752.png)
