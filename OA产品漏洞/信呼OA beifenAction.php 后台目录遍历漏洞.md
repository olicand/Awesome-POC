...
![image-20220520133147020](../.gitbook/assets/202205201331106.png)

其中默认存在几个用户存在弱口令 123456

![image-20220520133200310](../.gitbook/assets/202205201332409.png)

存在漏洞的文件为 `webmain/system/beifen/beifenAction.php`

![image-20220520133212813](../.gitbook/assets/202205201332896.png)

查看 `getfilerows()` 方法，在 `include/chajian/fileChajian.php`

![image-20220520133224646](../.gitbook/assets/202205201332744.png)
...
![image-20220520133237936](../.gitbook/assets/202205201332997.png)
